-- ============================================
-- 데이터베이스 클론 스크립트 Part 2: Exercises 시드 데이터
-- DBeaver에서 실행용
-- ============================================
-- 사용법: dbclone_01_drop_and_schema.sql 실행 후 이 파일을 실행합니다.

-- ============================================
-- 기본 운동 목록 시딩 (3대 운동 + 대체 운동)
-- ============================================

-- 벤치프레스 관련 (name_en을 strength_standards가 찾는 이름으로 설정)
INSERT INTO exercises (id, name, name_en, category, body_part, unit, is_active, created_at, updated_at)
VALUES 
    (gen_random_uuid(), '벤치프레스', 'Bench Press - Powerlifting', 'UPPER', '가슴', 'kg', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
-- 스쿼트 관련 (name_en을 strength_standards가 찾는 이름으로 설정)
INSERT INTO exercises (id, name, name_en, category, body_part, unit, is_active, created_at, updated_at)
VALUES 
    (gen_random_uuid(), '스쿼트', 'Barbell Squat', 'LOWER', '하체', 'kg', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
-- 데드리프트 관련 (name_en을 strength_standards가 찾는 이름으로 설정)
INSERT INTO exercises (id, name, name_en, category, body_part, unit, is_active, created_at, updated_at)
VALUES 
    (gen_random_uuid(), '데드리프트', 'Barbell Deadlift', 'FULL_BODY', '하체', 'kg', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
-- ============================================
-- Free Exercise DB 데이터 포함
-- ============================================
-- 주의: free_exercise_db_seed.sql 파일이 매우 큽니다 (4000+ 줄).
-- 아래에 free_exercise_db_seed.sql의 전체 내용이 포함되어 있습니다.
-- ============================================
...
-- Part 2 완료 메시지
-- ============================================
SELECT 'Part 2: Exercises seed data inserted! Now run dbclone_03_bench_press_standards.sql' AS message;
