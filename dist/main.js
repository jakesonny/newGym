...
let AssessmentsService = AssessmentsService_1 = class AssessmentsService {
    ...
    async getHexagonData(memberId, includeInitial = false) {
        ...
        const current = {
            indicators: analytics_helper_1.AnalyticsHelper.toHexagonIndicatorsObject(snapshot),
        ...
        if (includeInitial) {
            ...
            return {
                ...
                initial: initialSnapshot
                    ? {
                        indicators: analytics_helper_1.AnalyticsHelper.toHexagonIndicatorsObject(initialSnapshot),
...
class AnalyticsHelper {
    ...
    static toHexagonIndicatorsObject(snapshot) {
        if (!snapshot) {
            return {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.HexagonDataDto = exports.HexagonIndicatorsDto = void 0;
const swagger_1 = __webpack_require__(4);
class HexagonIndicatorsDto {
}
exports.HexagonIndicatorsDto = HexagonIndicatorsDto;
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: '하체 근력 점수 (0-100)', example: 75, nullable: true }),
    __metadata("design:type", Number)
], HexagonIndicatorsDto.prototype, "lowerBodyStrength", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: '심폐 지구력 점수 (0-100)', example: 60, nullable: true }),
    __metadata("design:type", Number)
], HexagonIndicatorsDto.prototype, "cardiorespiratoryEndurance", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: '근지구력 점수 (0-100)', example: 70, nullable: true }),
    __metadata("design:type", Number)
], HexagonIndicatorsDto.prototype, "muscularEndurance", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: '유연성 점수 (0-100)', example: 65, nullable: true }),
    __metadata("design:type", Number)
], HexagonIndicatorsDto.prototype, "flexibility", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: '체성분 밸런스 점수 (0-100)', example: 80, nullable: true }),
    __metadata("design:type", Number)
], HexagonIndicatorsDto.prototype, "bodyComposition", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: '부상 안정성 점수 (0-100)', example: 72, nullable: true }),
    __metadata("design:type", Number)
], HexagonIndicatorsDto.prototype, "stability", void 0);
...
__decorate([
    ...
    __metadata("design:type", HexagonIndicatorsDto)
...
let StrengthLevelController = class StrengthLevelController {
    ...
    async calculate(dto) {
        ...
        return api_response_1.ApiResponseHelper.success(data, 'Strength Level 계산 성공');
    }
};
...
**비로그인 사용 가능** - 로그인 없이도 측정 가능합니다.
    ...
    (0, swagger_1.ApiResponse)({
        ...
        type: strength_level_response_dto_1.StrengthLevelData,
    }),
    (0, swagger_1.ApiResponse)({
        status: 400,
